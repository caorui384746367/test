...
public class CommitHomework3 {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			String user = null;
			String strs [] = new String[] {"1990","2060","2841","31685"};
			while((user=br.readLine())!=null) {
				String username = user.split("----")[0];
				String password = user.split("----")[1];
				
				for(int i=0;i<4;i++) {				
					commitHomework(username,password,strs[i]);
	...
	public static void commitHomework(String username,String password,String homeworkId) {
		try {
			...
			Connection con4 = Jsoup
					.connect("http://cs.xnjd.cn/course/exercise/Student_doIt.action;jsessionid="+login.cookie("JSESSIONID")+"?courseId=360&homeworkId="+homeworkId);
			...
			/**作业提交*/
			//获取提交的参数
			String glo_homework_id = doc4.getElementById("glo_homework_id").val();
			...
			//读取文件，设置answer
			/**需要修改*/
			File englisfile = new File("C:\\Users\\Administrator\\Desktop\\answer3\\answer"+glo_homework_id+".txt");

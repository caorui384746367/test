	...
	public static void commitHomework(String username,String password,String homeworkId) {
		try {
			...
			Connection con4 = Jsoup
					.connect("http://cs.xnjd.cn/course/exercise/Student_doIt.action;jsessionid="+login.cookie("JSESSIONID")+"?courseId=534&homeworkId="+homeworkId);
			...
			//读取文件，设置answer
			/**需要修改*/
			File englisfile = new File("C:\\Users\\Administrator\\Desktop\\answer4\\answer"+glo_homework_id+".txt");

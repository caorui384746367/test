...
public class CommitHomeworkRondom {
	...
	public static void main(String[] args) throws Exception {
		...
		String homeworkId ="64";
		String courseId = "7";
		commitHomework(username,password,homeworkId,courseId);
	}
	public static void commitHomework(String username,String password,String homeworkId,String courseId) {
		try {
			/** index首页展示 */
			// 加载网页解析成doc文档
			...
			//读取文件，设置answer
			/**需要修改*/
			File englisfile = new File("C:\\Users\\Administrator\\Desktop\\lastAnswer.txt");
